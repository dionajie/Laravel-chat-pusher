...
<head>
  ...
  <title>Startup Discovery OIM | Dashboard</title>
  ...
  <link rel="stylesheet" href="{{ URL::asset('admin/css/skins/skin-red.min.css') }}">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="font-size: 17px;">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="{{ url('/chat') }}"><i class="fa fa-dashboard"></i> <span>Chat</span></a>
        </li>
    </ul>
    </section>
    <!-- /.sidebar -->
